...
export const TextAlignButton = React.forwardRef(({ editor: providedEditor, align, text, hideWhenUnavailable = false, className = '', disabled, onClick, children, ...buttonProps }, ref) => {
    ...
    return (_jsx(Button, { type: "button", className: className.trim(), disabled: isDisabled, "data-style": "ghost", "data-active-state": isActive ? 'on' : 'off', "data-disabled": isDisabled, role: "button", tabIndex: -1, "aria-label": label, "aria-pressed": isActive, tooltip: label, shortcutKeys: shortcutKey, onClick: handleClick, ...buttonProps, ref: ref, children: children || (_jsxs(_Fragment, { children: [_jsx(Icon, { className: "tiptap-button-icon" }), text && _jsx("span", { className: "tiptap-button-text", children: text })] })) }));
});
