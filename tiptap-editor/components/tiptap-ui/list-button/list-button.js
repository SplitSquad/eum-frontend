...
export const ListButton = React.forwardRef(({ editor: providedEditor, type, hideWhenUnavailable = false, className = '', onClick, text, children, ...buttonProps }, ref) => {
    ...
    return (_jsx(Button, { type: "button", className: className.trim(), "data-style": "ghost", "data-active-state": isActive ? 'on' : 'off', role: "button", tabIndex: -1, "aria-label": listOption?.label || type, "aria-pressed": isActive, tooltip: listOption?.label || type, shortcutKeys: shortcutKey, onClick: handleClick, ...buttonProps, ref: ref, children: children || (_jsxs(_Fragment, { children: [_jsx(Icon, { className: "tiptap-button-icon" }), text && _jsx("span", { className: "tiptap-button-text", children: text })] })) }));
});
