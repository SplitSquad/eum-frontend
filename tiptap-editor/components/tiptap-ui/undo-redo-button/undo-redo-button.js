...
// --- Icons ---
import { Redo2Icon } from '@tiptap-editor/components/tiptap-icons/redo2-icon';
import { Undo2Icon } from '@tiptap-editor/components/tiptap-icons/undo2-icon';
// --- UI Primitives ---
 ...
 */
export const UndoRedoButton = React.forwardRef(({ editor: providedEditor, action, text, className = '', disabled, onClick, children, ...buttonProps }, ref) => {
    ...
    return (_jsx(Button, { ref: ref, type: "button", className: className.trim(), disabled: isDisabled, "data-style": "ghost", "data-disabled": isDisabled, role: "button", tabIndex: -1, "aria-label": actionLabel, tooltip: actionLabel, shortcutKeys: shortcutKey, onClick: handleClick, ...buttonProps, children: children || (_jsxs(_Fragment, { children: [_jsx(Icon, { className: "tiptap-button-icon" }), text && _jsx("span", { className: "tiptap-button-text", children: text })] })) }));
});
