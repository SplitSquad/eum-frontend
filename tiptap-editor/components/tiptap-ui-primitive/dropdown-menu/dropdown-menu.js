...
export const DropdownMenuContent = React.forwardRef(({ style, className, orientation = 'vertical', side = 'bottom', align = 'start', portal = true, portalProps = {}, ...props }, propRef) => {
    const context = useDropdownMenuContext();
...
export const DropdownMenuSeparator = React.forwardRef(({ className, ...props }, ref) => (_jsx(Separator, { ref: ref, className: `tiptap-dropdown-menu-separator ${className || ''}`, ...props })));
