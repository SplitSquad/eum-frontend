...
export const Toolbar = React.forwardRef(({ children, className, variant = 'fixed', ...props }, ref) => {
    ...
    if (!isVisible)
        return null;
    return (_jsx("div", { ref: mergeRefs([toolbarRef, ref]), role: "toolbar", "aria-label": "toolbar", "data-variant": variant, className: `tiptap-toolbar ${className || ''}`, ...props, children: children }));
});
...
export const ToolbarGroup = React.forwardRef(({ children, className, ...props }, ref) => {
    ...
    if (!isVisible)
        return null;
    return (_jsx("div", { ref: mergeRefs([groupRef, ref]), role: "group", className: `tiptap-toolbar-group ${className || ''}`, ...props, children: children }));
});
...
export const ToolbarSeparator = React.forwardRef(({ ...props }, ref) => {
    ...
    if (!isVisible)
        return null;
    return (_jsx(Separator, { ref: mergeRefs([separatorRef, ref]), orientation: "vertical", decorative: true, ...props }));
});
