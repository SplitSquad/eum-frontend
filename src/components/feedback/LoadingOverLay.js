...
const RightDoor = styled(motion.div) `
  ...
  align-items: stretch;
`;
const InnerDoorPanel = styled.div `
  width: 100%;
  height: 100%;
...
const LoadingOverlay = ({ isLoaded = true }) => {
    ...
    return (_jsxs("main", { className: "w-screen opacity-100 flex flex-col items-center justify-center", style: { minHeight: '100vh', height: 'auto' }, children: [_jsx(Floor, {}), _jsx(SquareContainer, { children: _jsxs(DoorWrapper, { children: [_jsx(LeftDoor, { initial: { x: 0 }, animate: { x: '-100%' }, transition: { duration: 2, ease: 'easeInOut' }, children: _jsx(InnerDoorPanel, {}) }), _jsx(RightDoor, { initial: { x: 0 }, animate: { x: '100%' }, transition: { duration: 2, ease: 'easeInOut' }, children: _jsx(InnerDoorPanel, { mirrored: true }) }), _jsxs(CenterContent, { doorsOpen: doorsOpen, children: [_jsx(Video, { src: EumAnimation, autoPlay: true, muted: true, loop: true }), _jsx(VideoBar, {})] })] }) }), _jsx(Floor, {}), _jsxs(IntroSlider, { currentIndex: currentIndex, children: [_jsx(Slide1, {}), _jsx(Slide2, {}), _jsx(Slide3, {})] })] }));
};
