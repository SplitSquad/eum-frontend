...
export const LeftDoor = styled(motion.div)`
  position: absolute;
  left: 0;
  top: 0;
  width: 50%;
...
export const RightDoor = styled(motion.div)`
  position: absolute;
  right: 0;
  top: 0;
  width: 50%;
...
export const InnerDoorPanel = styled.div<{ mirrored?: boolean }>`
  width: 100%;
  height: 100%;
...
export const CenterContent = styled.div<{ doorsOpen?: boolean }>`
  position: absolute;
  left: 0;
  right: 0;
  top: 0;
