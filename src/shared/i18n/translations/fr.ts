...
const fr = {
  ...
  mypage: {
    ...
    myprofile: {
      ...
      email: 'Email',
      noemail: 'Pas d\'Email',
      Introduceyourself: 'Présentation',
      nointroduction: 'Pas de Présentation',
      country: 'Pays',
      nocountry: 'Pas de Pays',
      language: 'Langue',
      nolanguage: 'Pas de Langue',
      Joineddate: 'Date d\'Inscription',
      nojoindate: 'Pas de Date d\'Inscription',
      visitpurpose: 'Objectif de la Visite',
      novistpurpose: 'Non Spécifié',
      ActivityStatistics: 'Statistiques d\'Activité',
      post: 'Publications Écrites',
      comment: 'Commentaires Écrits',
      debate: 'Débats Participés',
      Bookmark: 'Favoris Sauvegardés',
      badge: 'Mes Badges',
      nobadge: 'Pas encore de badges gagnés.',
      nobadge2: 'Collectez différents badges grâce à vos activités !',
      profileedit: 'Modifier le Profil',
      activitylevel: 'Niveau d\'Activité',
      save1: 'Enregistrer',
      save2: 'Enregistrement...',
      imagesize: 'Le fichier est trop volumineux ! Veuillez sélectionner une image de moins de 5MB 📁',
      imagetype: 'Seuls les fichiers image JPG, PNG, GIF peuvent être téléchargés 🖼️',
      imageupdetesuccess: 'L\'image de profil a été mise à jour avec succès ! 🎉',
      imageupdatefail: 'Échec du téléchargement de l\'image. Veuillez réessayer 😔',
      imagedeletesuccess: 'L\'image de profil a été supprimée avec succès ! ✨',
      imagedeletefail: 'Échec de la suppression de l\'image. Veuillez réessayer 😔'
    },
    inputname: 'Entrez votre nom',
    inputintroduction: 'Entrez votre présentation',
    cancelbtn: 'Annuler',
    savebtn: 'Enregistrer',
    trybtn: 'Réessayer',
    badge1name: 'Premier Article',
    badge1desc: 'Vous avez écrit votre premier article !',
    badge2name: 'Maître de la Communication',
    badge2desc: 'Vous avez écrit plus de 10 commentaires !',
    badge3name: 'Participant aux Débats',
    badge3desc: 'Vous avez participé à un débat et exprimé votre opinion !',
    badge4name: 'Collectionneur de Connaissances',
    badge4desc: 'Vous avez ajouté votre premier favori !',
    badge5name: 'Participant Actif',
