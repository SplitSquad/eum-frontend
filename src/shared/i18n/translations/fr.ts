...
const fr = {
  ...
  chatbot: {
    askHelp: 'Bonjour ! Comment puis-je vous aider ?',
    downloadImg: "Télécharger l'image",
    errorMessage: "Une erreur s'est produite lors de la réponse.",
    errorCalender: "Une erreur s'est produite lors de l'analyse du calendrier.",
    errorDelete: "Une erreur s'est produite lors de l'analyse des données de suppression.",
    failSchedule: "Une erreur s'est produite lors de l'analyse du planning.",
    failEdit: "Une erreur s'est produite lors de l'analyse des données d'édition.",
    schedule: '📅 Liste des plannings',
    noDescription: 'Aucune description',
    startDate: 'Début',
    endDate: 'Fin',
    deleteSchedule: 'Planning supprimé',
    successSchedule: 'Planning ajouté avec succès',
    successEdit: '📝 Planning modifié avec succès',
    location: 'Lieu',
    noLocation: 'Aucune information de lieu',
    address: 'Adresse',
    phone: 'Téléphone',
    distance: 'Distance',
    openPdf: 'Ouvrir PDF',
...
Voulez-vous vraiment sauvegarder?`,
      ...
      editModeWarning:
        '⚠️ Attention: Ajouter de nouveaux fichiers supprimera toutes les {{count}} pièces jointes existantes.\n\nVoulez-vous vraiment continuer?\n\nSélectionnez "Annuler" pour conserver les fichiers existants.',
      ...
      editModeDragOrClick:
        'Glissez des fichiers ou cliquez pour remplacer par de nouveaux fichiers',
    ...
    posts: {
      ...
      form: {
        ...
        validation: {
          ...
          subTagsRequired: 'Veuillez sélectionner au moins un sous-tag',
