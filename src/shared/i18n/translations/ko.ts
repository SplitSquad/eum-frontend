const ko = {
  ...
  community: {
    ...
    editPostNote: '💡 게시글 수정 시에는 제목과 내용만 변경 가능합니다. 게시글 타입, 카테고리, 지역, 태그는 수정할 수 없습니다.',
