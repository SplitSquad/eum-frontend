...
const ko = {
  ...
  chatbot: {
    ...
    errorCalender: '⛔ 일정을 불러오는 데 실패했습니다.',
    schedule: '📅 전체 일정',
    noDescription: '설명 없음',
    startDate: '시작:',
    endDate: '종료:',
    deleteSchedule: '🗑️ 일정이 삭제되었습니다.',
    errorDelete: '⛔ 삭제된 일정을 불러올 수 없습니다.',
    failSchedule: '⛔ 일정 정보를 불러올 수 없습니다.',
    successSchedule: '✅ 일정이 성공적으로 추가되었습니다.',
    location: '장소:',
    noLocation: '장소 없음',
    failEdit: '⛔ 수정된 일정을 불러올 수 없습니다.',
    successEdit: '✏️ 일정이 성공적으로 수정되었습니다.',
    address: '📍 주소:',
    phone: '📞 전화번호:',
    distance: '📏 거리:',
    openPdf: '📄 PDF 열기',
