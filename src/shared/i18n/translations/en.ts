const en = {
  ...
  community: {
    ...
    uploadSupportInfo: 'Images will be displayed as previews ✨\nMax 10MB, all file formats supported',
    ...
    editPostNote: '💡 When editing a post, only the title and content can be changed. Post type, category, region, and tags cannot be modified.',
  ...
  editModeFileWarning: 'Selecting new files will delete all existing attachments\nPlease choose carefully',
};
