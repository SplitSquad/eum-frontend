...
const PageLayout = ({ children, title }) => {
    ...
    return (_jsx(AppRoot, { children: _jsx(ContentLayer, { children: _jsx(BookContainer, { children: _jsxs(Book, { children: [_jsxs(LeftPage, { children: [_jsx(BookmarkRibbon, {}), _jsx(CornerOrnament, {}), _jsx(BottomOrnament, {}), _jsx(SidebarMenu, {})] }), _jsx(MobileSidebar, { isOpen: isMobileSidebarOpen, children: _jsx(SidebarMenu, {}) }), _jsx(Overlay, { isOpen: isMobileSidebarOpen, onClick: closeMobileSidebar }), _jsx(MobileMenuButton, { onClick: toggleMobileSidebar, "aria-label": "\uBA54\uB274 \uC5F4\uAE30/\uB2EB\uAE30", children: isMobileSidebarOpen ? (_jsxs(CloseIcon, { children: [_jsx("span", {}), _jsx("span", {})] })) : (_jsxs(MenuIcon, { children: [_jsx("span", {}), _jsx("span", {}), _jsx("span", {}), _jsx("span", {})] })) }), _jsxs(ContentArea, { isVisible: contentVisible, isLeaving: isLeaving, children: [_jsx(CornerOrnament, {}), _jsx(BottomOrnament, {}), _jsxs(PageContent, { children: [_jsx(BookTitle, { children: title }), content] })] })] }) }) }) }));
};
