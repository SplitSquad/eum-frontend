...
const ActivitiesPage = () => {
    ...
    // Store에서 데이터 가져오기
    const { posts, comments, bookmarks, debates, fetchMyPosts, fetchMyComments, fetchMyDebates, fetchMyBookmarks, postsLoading, commentsLoading, debatesLoading, bookmarksLoading, } = useMypageStore();
    // 로그인 상태 확인
    useEffect(() => {
    ...
    const renderIcon = (type) => {
        switch (type) {
            case 'post':
                return (_jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", children: [_jsx("path", { d: "M21.731 2.269a2.625 2.625 0 00-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 000-3.712zM19.513 8.199l-3.712-3.712-8.4 8.4a5.25 5.25 0 00-1.32 2.214l-.8 2.685a.75.75 0 00.933.933l2.685-.8a5.25 5.25 0 002.214-1.32l8.4-8.4z" }), _jsx("path", { d: "M5.25 5.25a3 3 0 00-3 3v10.5a3 3 0 003 3h10.5a3 3 0 003-3V13.5a.75.75 0 00-1.5 0v5.25a1.5 1.5 0 01-1.5 1.5H5.25a1.5 1.5 0 01-1.5-1.5V8.25a1.5 1.5 0 011.5-1.5h5.25a.75.75 0 000-1.5H5.25z" })] }));
            case 'comment':
                return (_jsx("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", children: _jsx("path", { fillRule: "evenodd", d: "M4.848 2.771A49.144 49.144 0 0112 2.25c2.43 0 4.817.178 7.152.52 1.978.292 3.348 2.024 3.348 3.97v6.02c0 1.946-1.37 3.678-3.348 3.97a48.901 48.901 0 01-3.476.383.39.39 0 00-.297.17l-2.755 4.133a.75.75 0 01-1.248 0l-2.755-4.133a.39.39 0 00-.297-.17 48.9 48.9 0 01-3.476-.384c-1.978-.29-3.348-2.024-3.348-3.97V6.741c0-1.946 1.37-3.68 3.348-3.97z", clipRule: "evenodd" }) }));
            case 'debate':
                return (_jsx("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", children: _jsx("path", { d: "M4.5 6.375a4.125 4.125 0 118.25 0 4.125 4.125 0 01-8.25 0zM14.25 8.625a3.375 3.375 0 116.75 0 3.375 3.375 0 01-6.75 0zM1.5 19.125a7.125 7.125 0 0114.25 0v.003l-.001.119a.75.75 0 01-.363.63 13.067 13.067 0 01-6.761 1.873c-2.472 0-4.786-.684-6.76-1.873a.75.75 0 01-.364-.63l-.001-.122zM17.25 19.128l-.001.144a2.25 2.25 0 01-.233.96 10.088 10.088 0 005.06-1.01.75.75 0 00.42-.643 4.875 4.875 0 00-6.957-4.611 8.586 8.586 0 011.71 5.157v.003z" }) }));
            case 'bookmark':
                return (_jsx("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", children: _jsx("path", { fillRule: "evenodd", d: "M6.32 2.577a49.255 49.255 0 0111.36 0c1.497.174 2.57 1.46 2.57 2.93V21a.75.75 0 01-1.085.67L12 18.089l-7.165 3.583A.75.75 0 013.75 21V5.507c0-1.47 1.073-2.756 2.57-2.93z", clipRule: "evenodd" }) }));
            default:
                return null;
        }
    };
    ...
    return (_jsx(PageLayout, { title: "\uD65C\uB3D9 \uB0B4\uC5ED", children: _jsxs(PageContainer, { children: [_jsxs(TabContainer, { children: [_jsx(Tab, { active: activeTab === 'all', onClick: () => handleTabChange('all'), children: "\uC804\uCCB4" }), _jsx(Tab, { active: activeTab === 'posts', onClick: () => handleTabChange('posts'), children: "\uAC8C\uC2DC\uBB3C" }), _jsx(Tab, { active: activeTab === 'comments', onClick: () => handleTabChange('comments'), children: "\uB313\uAE00" }), _jsx(Tab, { active: activeTab === 'debates', onClick: () => handleTabChange('debates'), children: "\uD1A0\uB860" }), _jsx(Tab, { active: activeTab === 'bookmarks', onClick: () => handleTabChange('bookmarks'), children: "\uBD81\uB9C8\uD06C" })] }), _jsx(InfoCard, { title: `${activeTab === 'all' ? '전체' : activeTab === 'posts' ? '게시물' : activeTab === 'comments' ? '댓글' : activeTab === 'debates' ? '토론' : '북마크'} 활동`, children: isLoading() ? (_jsx(LoadingContainer, { children: _jsx(CircularProgress, { size: 30 }) })) : activities.length === 0 ? (_jsx(EmptyState, { children: "\uC544\uC9C1 \uD65C\uB3D9 \uB0B4\uC5ED\uC774 \uC5C6\uC2B5\uB2C8\uB2E4." })) : (_jsx(ActivityList, { children: activities.map((activity, index) => (_jsxs(ActivityItem, { onClick: activity.onClick, children: [_jsx(ActivityIcon, { children: renderIcon(activity.type) }), _jsxs(ActivityContent, { children: [_jsx(ActivityTitle, { children: activity.title }), _jsx(ActivityDescription, { children: activity.description }), _jsx(ActivityMeta, { children: _jsx(ActivityDate, { children: activity.date }) })] })] }, `${activity.type}-${activity.id}-${index}`))) })) })] }) }));
};
