...
const AuthGuard = ({ children, requiredRoles = [] }) => {
    ...
    if (isLoading || isChecking) {
        return (_jsxs(LoadingContainer, { children: [_jsx(CircularProgress, { size: 50, thickness: 4, sx: { color: '#FF9999' } }), _jsx(Typography, { mt: 3, variant: "body1", color: "textSecondary", children: "\uC778\uC99D \uD655\uC778 \uC911..." })] }));
    }
