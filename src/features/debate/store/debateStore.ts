...
import { Debate, DebateComment, DebateReply, DebateSortOption, ReactionType, DebateReqDto } from '../types';
...
interface DebateState {
  ...
  searchDebates: (keyword: string, searchBy?: string, page?: number, size?: number) => Promise<void>;
            ...
            if (debate) {
              ...
              set(state => {
                ...
                if (debate.comments) {
                  ...
                  updateState.totalComments = debate.commentOptions?.total || debate.comments.length;
