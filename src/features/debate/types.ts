 ...
 */
export function mapIsVotedStateToVoteType(isVotedState: string | null | undefined): 'pro' | 'con' | null {
 ...
 */
export function mapIsStateToEmotionType(isState: string | null | undefined): 'like' | 'dislike' | 'sad' | 'angry' | 'confused' | null {
