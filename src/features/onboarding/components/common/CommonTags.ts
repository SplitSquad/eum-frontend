...
export const interestTags = [
  ...
  // 정보 카테고리 추가
  { id: 'transportation_info', name: '교통' },
  { id: 'visa_legal', name: '비자/법률' },
  { id: 'finance_tax', name: '금융/세금' },
  { id: 'education_info', name: '교육' },
  { id: 'housing_realestate', name: '주거/부동산' },
  { id: 'healthcare', name: '의료/건강' },
  { id: 'shopping_info', name: '쇼핑' },
  { id: 'employment_workplace', name: '취업/직장' },
];
