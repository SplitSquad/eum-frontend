...
const RegionFilter = () => {
    const { selectedCity, selectedDistrict, selectedNeighborhood, districts, neighborhoods, setCity, setDistrict, setNeighborhood, } = useRegionStore();
    const labels = ['시', '구', '동'];
    ...
    return (_jsx("div", { className: "w-full max-w-3xl mx-auto mb-6", children: _jsx(DropDownGroup, { labels: labels, itemsList: itemsList, selected: selected, onSelect: handleSelect }) }));
};
