...
const PostListPage = () => {
    ...
    const handleSearch = () => {
        ...
        // 검색용 postType 설정
        let postTypeForSearch = selectedPostType === 'ALL' ? '자유' : selectedPostType;
        // 검색 시 필터 상태 업데이트
        const searchFilter = {
            ...filter,
            page: 0,
    ...
    const handlePostTypeChange = (newPostType) => {
        ...
        if (newPostType === 'ALL') {
            ...
            // 모임 게시글
            newFilter.postType = '모임'; // 명시적으로 타입 설정
    ...
    return (_jsxs(Container, { maxWidth: "lg", sx: {
            ...
            zIndex: 5,
                    ...
                    gap: 2,
                        ...
                        }, children: "\uCEE4\uBBA4\uB2C8\uD2F0 \uAC8C\uC2DC\uD310" }), _jsx(Button, { variant: "contained", startIcon: _jsx(CreateIcon, {}), onClick: handleCreatePost, sx: {
                            bgcolor: '#FFAAA5',
                            '&:hover': {
                                bgcolor: '#FF8B8B',
                            },
                    ...
                    backdropFilter: 'blur(8px)',
                            ...
                            flexWrap: 'wrap',
                                ...
                                } })] }), _jsxs(Collapse, { in: showFilters, children: [_jsx(Divider, { sx: { mb: 2, borderColor: 'rgba(255, 170, 165, 0.2)' } }), _jsxs(Box, { sx: {
                                    display: 'grid',
                                    gridTemplateColumns: isMobile ? '1fr' : 'repeat(auto-fit, minmax(200px, 1fr))',
                                    gap: 2,
                                }, children: [_jsxs(Box, { children: [_jsx(Typography, { variant: "subtitle2", gutterBottom: true, sx: { fontWeight: 600, color: '#555' }, children: "\uAC8C\uC2DC\uAE00 \uD0C0\uC785" }), _jsxs(ToggleButtonGroup, { color: "primary", value: selectedPostType, exclusive: true, onChange: (e, newPostType) => newPostType && handlePostTypeChange(newPostType), size: "small", sx: {
                                                    width: '100%',
                                                ...
                                                }, children: [_jsx(ToggleButton, { value: "ALL", sx: { width: '33%' }, children: "\uC804\uCCB4" }), _jsx(ToggleButton, { value: "\uC790\uC720", sx: { width: '33%' }, children: "\uC790\uC720 \uAC8C\uC2DC\uAE00" }), _jsx(ToggleButton, { value: "\uBAA8\uC784", sx: { width: '33%' }, children: "\uBAA8\uC784 \uAC8C\uC2DC\uAE00" })] })] }), selectedPostType === '모임' && (_jsxs(Box, { children: [_jsx(Typography, { variant: "subtitle2", gutterBottom: true, sx: { fontWeight: 600, color: '#555' }, children: "\uC9C0\uC5ED \uC120\uD0DD" }), _jsx(RegionSelector, { selectedRegion: selectedRegion, onChange: handleRegionChange })] })), _jsxs(Box, { sx: { gridColumn: isMobile ? 'auto' : '1 / -1' }, children: [_jsx(Typography, { variant: "subtitle2", gutterBottom: true, sx: { fontWeight: 600, color: '#555' }, children: "\uCE74\uD14C\uACE0\uB9AC \uC120\uD0DD" }), _jsxs(ToggleButtonGroup, { color: "primary", value: selectedCategory, exclusive: true, onChange: (e, newValue) => newValue && handleCategoryChange(newValue), size: "small", sx: {
                                                    width: '100%',
                                                    flexWrap: 'wrap',
                                                    mb: 2,
                                                    '& .MuiToggleButton-root': {
