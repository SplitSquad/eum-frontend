...
const GroupListPage = () => {
    ...
    const [filter, setFilter] = useState({
        ...
        size: 6,
        postType: queryParams.get('postType') || '모임',
    });
    ...
    return (_jsxs(Container, { maxWidth: "lg", sx: {
            ...
            zIndex: 5,
                    ...
                    gap: 2,
                        ...
                        }, children: "\uBAA8\uC784 \uAC8C\uC2DC\uD310" }), _jsx(Button, { variant: "contained", startIcon: _jsx(CreateIcon, {}), onClick: handleCreatePost, sx: {
                            bgcolor: '#FFAAA5',
                            '&:hover': {
                                bgcolor: '#FF8B8B',
                            },
